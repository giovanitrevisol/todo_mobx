...
mixin _$LoginStore on _LoginStore, Store {
  ...
  bool get isPasswordvalid => (_$isPasswordvalidComputed ??=
      ...
      .value;
  Computed<Function> _$loginPressetComputed;

  @override
  Function get loginPresset =>
      (_$loginPressetComputed ??= Computed<Function>(() => super.loginPresset))
          .value;
  ...
  String toString() {
    final string =
        'email: ${email.toString()},password: ${password.toString()},passwordVisible: ${passwordVisible.toString()},loading: ${loading.toString()},loggedIn: ${loggedIn.toString()},isEmailValid: ${isEmailValid.toString()},isPasswordvalid: ${isPasswordvalid.toString()},loginPresset: ${loginPresset.toString()}';
    return '{$string}';
  }
}
